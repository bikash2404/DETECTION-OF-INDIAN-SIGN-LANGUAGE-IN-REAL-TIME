...
class Application:
    def __init__(self):
        ...
        self.json_file = open("model_az.json", "r")
        self.model_json = self.json_file.read()
        self.json_file.close()
        self.loaded_model = model_from_json(self.model_json)
        self.loaded_model.load_weights("model_az.h5")
        self.ct = {}
        self.ct["blank"] = 0
        self.blank_flag = 0
        ...
        tts_button = tk.Button(self.root, text="Text to Sign Conversion", 
                               font=("Comic Sans MS", 14, "bold"), 
                               bg="#E48F1B", fg="#34262B", command=text_Sign)
    ...
    def video_loop(self):
        ...
        if ok:
            ...
            self.panel3.config(text=self.current_symbol, font=("Comic Sans MS", 10), bg="#E0E0E0")
